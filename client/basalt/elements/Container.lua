...
--- Retrieves a child element from the container by its path.
--- @shortDescription Gets a child element from the container by path.
--- @param path string The path to the child element to retrieve.
--- @return Container? The child container instance if found, or nil if not found.
